...
| 2b | `MIT` | `LISTAAPURACOES317` | Consultar | Sim — lista as apurações MIT do PA; o detalhe oficial usa `MIT/CONSAPURACAO316` com `idApuracao` |
...
- `dctfweb-mit-normalizer.js` (`MIT/LISTAAPURACOES317` + `MIT/CONSAPURACAO316` — **confirma os campos de código/valor/descrição dos débitos**; hoje o normalizador tenta vários nomes defensivamente)

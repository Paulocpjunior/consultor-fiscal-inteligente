...
import CurrencyInput from './SimplesNacional/CurrencyInput';
import SidebarCards from './SimplesNacional/SidebarCards';
    ...
    return (
        <div className="animate-fade-in pb-10">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <SidebarCards
                    totalRbt12Manual={totalRbt12Manual}
                    resumo={resumo}
                    folha12Input={folha12Input}
                    setFolha12Input={setFolha12Input}
                    onUpdateFolha12={onUpdateFolha12}
                    empresaId={empresa.id}
                    notas={notas}
                    onAbrirHistoricoModal={() => setIsHistoryModalOpen(true)}
                />
            </div>

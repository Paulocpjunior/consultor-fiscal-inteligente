...
const LucroPresumidoRealDashboard: React.FC<LucroPresumidoRealDashboardProps> = ({ currentUser, externalSelectedId, onAddToHistory }) => {
    ...
    const [saldoAnteriorLc224, setSaldoAnteriorLc224] = useState(0);
    ...
    useEffect(() => {
        if (view === 'new_ficha' && selectedFichaId && selectedEmpresa) {
            ...
            if (ficha) {
                ...
                setSaldoAnteriorLc224(ficha.saldoLimiteAnteriorLc224 || 0);
    ...
    const liveResults = useMemo(() => {
        ...
        const liveInput: LucroInput = {
            ...
            saldoLimiteAnteriorLc224: saldoAnteriorLc224,
    ...
    const renderNewFicha = () => (
        <NewFichaView
            ...
            saldoAnteriorLc224={saldoAnteriorLc224} setSaldoAnteriorLc224={setSaldoAnteriorLc224}

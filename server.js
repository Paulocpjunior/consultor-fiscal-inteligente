...
import pisCofinsCreditoRouter from './sefaz-backend/pis-cofins-credito-routes.js';
import nftsRouter from './sefaz-backend/nfts-routes.js';
import cofreChecklistRouter from './sefaz-backend/cofre-checklist-routes.js';
import conferenciaChavesRouter from './sefaz-backend/conferencia-chaves-routes.js';
...
import sefazSyncCteRouter from './sefaz-backend/sync-cte-routes.js';
import ncmRouter from './sefaz-backend/ncm-routes.js';
...
import relatoriosRouter from './sefaz-backend/relatorios-routes.js';
...
import empresasMergeRouter from './sefaz-backend/empresas-merge-routes.js';
...
app.use('/api/admin/sefaz', provaCapturaRouter);
app.use('/api/admin/sefaz', ipiVarreduraRouter);
app.use('/api/admin/sefaz', backlogEntradaRouter);
app.use('/api/admin/pis-cofins', pisCofinsCreditoRouter);
app.use('/api/admin/nfts', nftsRouter);
app.use('/api/admin/sefaz', cofreChecklistRouter);
app.use('/api/admin/sefaz', conferenciaChavesRouter);
app.use('/api/admin/sefaz', xmlEmailIngestRouter);
app.use('/api/admin/sefaz', sefazSyncRouter);
app.use('/api/admin/sefaz', sefazSyncCteRouter);
app.use('/api/admin/ncm', ncmRouter);
...
app.use('/api/admin/relatorios', relatoriosRouter);
...
// Fase 4 do túnel: o CFI assina E transmite o lote EFD-Reinf (a chave não
// viaja — assinatura e mTLS acontecem aqui). Produção restrita por padrão.
app.use('/api/admin/reinf/gateway', reinfGatewayRouter);

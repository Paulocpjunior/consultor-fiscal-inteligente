...
import { dataBrParaIso } from '../services/ultrafox-browser-parser.js';
export { dataBrParaIso, interpretarConversaTxt } from '../services/ultrafox-browser-parser.js';
...
// A implementação vive no módulo compartilhado acima para navegador e
// backend usarem a mesma regra sem levar `crypto` do Node para o bundle.

// ─── Conversa .txt (formato de export do WhatsApp) ──────────────────────────

// A leitura de conversa .txt também é reexportada do módulo compartilhado.
